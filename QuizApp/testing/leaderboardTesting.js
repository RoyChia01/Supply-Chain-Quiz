...
const initialLeaderboardData = [
  ...
  { id: '6', name: 'Chris Green', title: 'Private', score: 80 },
  { id: '7', name: 'Chris Green', title: 'Private', score: 80 },
  { id: '8', name: 'Chris Green', title: 'Private', score: 80 },
  { id: '9', name: 'Chris Green', title: 'Private', score: 80 },
  { id: '10', name: 'Chris Green', title: 'Private', score: 80 },
  { id: '11', name: 'Chris Green', title: 'Private', score: 80 },
  ...
  return (
    ...
    <View style={styles.topContainer}>
      {[topThree[1], topThree[0], topThree[2]].map((player, index) => (
        <View 
          key={player.id} 
          style={[styles.section, index === 1 ? { backgroundColor: '#5B7F94' } : [styles.sideSection, { backgroundColor: '#3A5F77' }]]}> 
          ...
          <Text style={[styles.text, styles.number]}>{index === 0 ? 2 : index === 1 ? 1 : 3}</Text>
        </View>
      ))}
    </View>
